...
GOOGLE_REDIRECT_URI=https://surgery-command.preview.emergentagent.com/api/google/callback
AUTO_ARCHIVE_DELAY_HOURS=48
```

### Frontend
```
REACT_APP_BACKEND_URL=https://surgery-command.preview.emergentagent.com
```
