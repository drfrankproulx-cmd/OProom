...
GOOGLE_REDIRECT_URI=https://surgical-planner-1.preview.emergentagent.com/api/google/callback
AUTO_ARCHIVE_DELAY_HOURS=48
```

### Frontend
```
REACT_APP_BACKEND_URL=https://surgical-planner-1.preview.emergentagent.com
```
