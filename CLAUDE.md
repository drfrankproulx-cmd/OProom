...
GOOGLE_REDIRECT_URI=https://or-scheduler-v2.preview.emergentagent.com/api/google/callback
AUTO_ARCHIVE_DELAY_HOURS=48
```

### Frontend
```
REACT_APP_BACKEND_URL=https://or-scheduler-v2.preview.emergentagent.com
```
