...
5. Add **Authorized redirect URIs**:
   ```
   https://clinic-scheduler-v2.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://clinic-scheduler-v2.preview.emergentagent.com/api/google/callback`
