...
5. Add **Authorized redirect URIs**:
   ```
   https://oproom.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://oproom.preview.emergentagent.com/api/google/callback`
