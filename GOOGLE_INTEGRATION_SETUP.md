...
5. Add **Authorized redirect URIs**:
   ```
   https://hipaa-ready-test.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://hipaa-ready-test.preview.emergentagent.com/api/google/callback`
