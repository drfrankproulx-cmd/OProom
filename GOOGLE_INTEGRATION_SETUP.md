...
5. Add **Authorized redirect URIs**:
   ```
   https://preop-hub.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://preop-hub.preview.emergentagent.com/api/google/callback`
