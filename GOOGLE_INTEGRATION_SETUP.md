...
5. Add **Authorized redirect URIs**:
   ```
   https://surgical-planner-1.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://surgical-planner-1.preview.emergentagent.com/api/google/callback`
