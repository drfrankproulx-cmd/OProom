...
5. Add **Authorized redirect URIs**:
   ```
   https://surgery-planner-3.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://surgery-planner-3.preview.emergentagent.com/api/google/callback`
