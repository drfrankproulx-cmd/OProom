...
5. Add **Authorized redirect URIs**:
   ```
   https://surgery-command.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://surgery-command.preview.emergentagent.com/api/google/callback`
