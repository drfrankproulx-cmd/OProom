...
5. Add **Authorized redirect URIs**:
   ```
   https://or-scheduler-v2.preview.emergentagent.com/api/google/callback
   ```
...
- Ensure the redirect URI exactly matches: `https://or-scheduler-v2.preview.emergentagent.com/api/google/callback`
